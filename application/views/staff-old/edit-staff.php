                ...
                <div class="pt-3 border-radius-xl bg-white" data-animation="FadeIn">
                    ...
                    <div class="multisteps-form__content">
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group input-group-static">
                                    <select name="role" class="form-control" id="staff_type" required="">
                                        <option value="<?=$staff['role']?>" selected disabled>
                                            <?=strtoupper($staff['role'])?></option>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group input-group-static">
                                    <input class="form-control" name="email" type="text" value="<?=$staff['email']?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group input-group-static">
                                    <input class="form-control" name="phone" type="text" value="<?=$staff['phone']?>">
                                </div>
                            </div>
                        </div>
