                ...
                <?php foreach ($stalls as $stall) { ?>
                  <tr>
                    ...
                    <td class="align-middle">
                      ...
                      <a href="<?=base_url('staff/delete/stalltype/'. $stall['link']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete exhibition">
