                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-12 mt-3 mt-sm-0">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class=" form-control" type="date" name="date_added" id="date_added" value="<?php echo $slider['date_added']; ?>" required>
                                </div>
                            </div>
...
<script>
    ...
    function removeimg() {
        ...
        $.ajax({
            url: "<?=base_url('staff/removeslider/'.$link); ?>", //the page containing php script
