            ...
            <table class="table table-flush" id="contacts-list">
              <thead>
                <tr>
                  ...
                  <!-- <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Stall Id</th> -->
              ...
              <tbody>
                <?php foreach ($exhibitions as $contact) { ?>
                  <tr>
                    ...
                    <!-- <td>
                      <p class="text-xs font-weight-bold mb-0"><?= $contact['stall_id']; ?></p>
                    </td> -->
                    <td>
                      <p class="text-xs font-weight-bold mb-0"><?= $contact['booking_date']; ?></p>
                    </td>
                    <td>
                      <a href="<?= base_url('staff/delete/booked-stalls/' . $contact['id']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete exhibition">
