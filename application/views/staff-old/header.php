    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?= base_url(); ?>" target="_blank">
                <img src="<?= base_url('assets/front/images/logo.png'); ?>" style="background:#fff" alt="" srcset="">&nbsp; 
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="<?= base_url('staff/gallerys'); ?>">
                        ...
                        <span class="nav-link-text ms-1">Gallery (<?php //$CI = &get_instance(); echo $CI->Global_model->countseen('tourenquiry');?>)</span>
                    </a>
                </li>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky noPrint" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <img src="<?= base_url('assets/front/images/logo.png'); ?>" style="height:3rem" alt="" srcset="">
                </nav>
