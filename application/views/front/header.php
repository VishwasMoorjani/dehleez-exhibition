      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-md-10">
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" id="navbarSupportedContent">

              <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasExampleLabel">Dahleez</h5>
