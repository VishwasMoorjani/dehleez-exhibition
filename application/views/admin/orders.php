                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <?php if ($stall['booked_by'] == 'user') { ?>
                                        <a href=""><span
                                                class="badge badge-sm bg-gradient-success">Online By User</span></a>
                                        <?php } elseif ($stall['booked_by'] == 'admin') { ?>
                                        <a href=""><span
                                                class="badge badge-sm bg-gradient-secondary">Booked By Admin</span></a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <?php $today = date('Y-m-d');
                                                    foreach ($allexhibitions as $exhibitionss) {
                                                      if ($stall['exhibition_id'] == $exhibitionss['id']) {
                                    ...
                                    <td class="align-middle">
                                        <?php
                            $today = date('Y-m-d');
                            foreach ($allexhibitions as $exhibitionsss) {
                              if ($stall['exhibition_id'] == $exhibitionsss['id']) {
                                if($exhibitionsss['start_date'] > $today ){
                                  if($stall['booked_by'] == 'user'){ ?>
                                      <a href="<?= base_url('admin/cancelorder/' . $stall['id']); ?>"
                                          class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                          data-original-title="Add Images">
                                          <i class="fas fa-image"></i>Cancel Booking
                                      </a>
                                  <?php }else{ ?>
                                         <a href="<?= base_url('admin/delete/booked-stalls/' . $stall['id']); ?>"
                                            class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                            data-original-title="Add Images">
                                            <i class="fas fa-image"></i>Cancel Booking
                                        </a>
