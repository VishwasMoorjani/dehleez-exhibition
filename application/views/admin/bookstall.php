        ...
        <div class="pt-3 border-radius-xl bg-white" data-animation="FadeIn">
          <div class="multisteps-form__content">
            <div class="row mt-3">
              ...
              <input type="hidden" name="booked_by" value="admin">
              ...
              <div class="col-12 col-sm-6">
                <label for="stallnumber">Stall Number <strong>(For Multiple Selections - Please use Ctrl + Mouse Click)</strong></label>
                <div class="input-group input-group-static m-2">
              ...
              <div class="col-12 col-sm-6">
                <label for="remark">Mode Of Payment</label>
                <div class="input-group input-group-static m-2">
