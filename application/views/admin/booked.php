      ...
      <div class="card">
        ...
        <div class="card-body p-3"> 
            <ul class="list-unstyled d-flex gap-3 flex-wrap justify-content-center">
                ...
                ?>
                <li><a class="border p-2" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#" 
                data-bs-date="<?= $contact['booking_date']; ?>" 
                data-bs-price="<?= $contact['price']; ?>"
                data-bs-stall_number="<?= $contact['stall_number']; ?>" 
                data-bs-exhibition="<?php foreach ($allexhibitions as $exhibition) {
                ...
                data-link="<?=base_url('admin/profile/'.$contact['user_id'])?>" 
                                                                >
            ...
            <table class="table table-flush" id="contacts-list">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exhibition Id</th>
                </tr>
              </thead>
              <tbody>
                 <?php foreach ($exhibitions as $contact) { ?>
                  <tr>
                    ...
                    <td>
                      <p class="text-xs font-weight-bold mb-0"><?php foreach ($allexhibitions as $exhibition) {
                                                                  if ($contact['exhibition_id'] == $exhibition['id']) {
                                                                    echo $exhibition['name'];
                                                                  }
                                                                } ?></p>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row gap-2">
                <div class="col-md-12"><p class="border-bottom px-2"><a id="dynamicLinks" href="#"  class="username" href="#"></a></p></div>
                <div class="col-md-12"><p class="phone border-bottom px-2"></p></div>
                <div class="col-md-12"><p class="email border-bottom px-2"></p></div>
                <div class="col-md-12"><p class="exhibition border-bottom px-2"></p></div>
                <div class="col-md-12"><p class="stall_number border-bottom px-2"></p></div>
                <div class="col-md-12"><p class="price border-bottom px-2"></p></div>
                <div class="col-md-12"><p class="date border-bottom px-2"> </p></div>
            </div> 
        </div>
