...
<div class="container-fluid py-4 mt-5">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <!--        </div>-->
            <!--        <div class="col-4 col-sm-4"><textarea name="value" rows="6" cols="30"><?php //strip_tags($this->Global['footercontent']); ?></textarea></div>-->
            <!--        <div class="col-4 col-sm-4"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>-->
            <!--    </div>-->
            <!--    <hr style=" color: #000; opacity: 100%;border-style: inset;border-width: 1px;">-->
            <!--</form>-->
            ...
            <form class="multisteps-form__form" method="post" action="editsettings">
                <div class="row mt-2">
                    <div class="col-4 col-sm-4">
                    <input type="text" name="name" value="referral_amount" hidden>
                        Referral Amount
                    </div>
                    <div class="col-4 col-sm-4">
                        <input type="text" name="value" value="<?=($this->Global['referral_amount']); ?>" id="">
                    </div>
                    <div class="col-4 col-sm-4"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>
                </div>
                <hr style=" color: #000; opacity: 100%;border-style: inset;border-width: 1px;">
            ...
            <form class="multisteps-form__form" method="post" action="editsettings">
                <div class="row mt-2">
                    <div class="col-4 col-sm-4">
                    <input type="text" name="name" value="gst" hidden>
                        GST
                    </div>
                    <div class="col-4 col-sm-4">
                        <input type="number" name="value" value="<?=($this->Global['gst']); ?>" step="0.01" id="">
                    </div>
                    <div class="col-4 col-sm-4"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>
                </div>
                <hr style=" color: #000; opacity: 100%;border-style: inset;border-width: 1px;">
