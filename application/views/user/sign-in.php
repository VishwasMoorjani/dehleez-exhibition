...
<section class="inner-pages text-center">
  ...
  <section id="login">
    <div class="container">
      ...
      <form class="mb-3 row justify-content-center" action="<?=base_url('user/login');?>" method="post">
        <div class="col-12">
        ...
        <!-- <div class="col-12">
          <a href="<?=base_url('user/loging')?>" class="view w-100">LOGIN</a>
        </div> -->
        <div class="col-12">
                <button type="submit" name="loginSubmit"  class="view w-100">LOGIN</button>
            </div>
      </form>
