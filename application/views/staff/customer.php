              ...
              <tbody>
                <?php foreach ($customers as $contact) { ?>
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-dark" href="<?=base_url('staff/order_history/'.$contact['id']); ?>">View Bookings</a>
                        <a class="btn btn-dark" href="<?=base_url('staff/profile/'.$contact['id']); ?>">View Profile</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
