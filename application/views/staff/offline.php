                ...
                ?>
                  ...
                  <td>
                    ...
                    <td class="align-middle">
                      <a onclick="return confirm('Are you sure to delete item?')?window.location.href='<?= base_url('staff/cancelofflinebookings/booked-stalls/' . $stall['id']); ?>':false;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Add Images">
