                    ...
                    <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="<?= base_url('staff/bookstallsforuser/' . $users['id']); ?>" role="tab" aria-selected="false">
                        ...
                        <div class="col-12 col-xl-12">
                            <div class="card card-plain h-100">
                                ...
                                <ul class="list-group">
                                    ...
                                    <form class="row inr my-3" action="<?= base_url('staff/editwallet'); ?>" method="post">

                                        <div class="col-md-4">
                                            <input type="hidden" name="id" value="<?= $users['id']; ?>" />
                                            <input class="form-control border px-3" name="wallet" type="number" step="0.01" placeholder="Enter amount to be debited  *" required />
                                        </div>

                                        <div class="col-md-4">
                                            <input class="form-control border px-3" name="remark" type="text" placeholder="Enter remark*" required />
                                        </div>

                                        <div class="col-md-4">
                                            <button class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1" type="submit" name="debit">Debit </button>
                                        </div>

                                    </form>


                                    <form class="row inr" action="<?= base_url('staff/editwallet'); ?>" method="post">

                                        <div class="col-md-4">
                                            <input type="hidden" name="id" value="<?= $users['id']; ?>" />
                                            <input class="form-control border px-3" name="wallet" type="number" step="0.01" placeholder="Enter amount to be credited *" required />
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <button class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1" type="submit" name="credit">Credit </button>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($orders as $contact) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?= $contact['booked_by']; ?>
                                                </p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">
                                                    ...
                                                    foreach ($exhibitions as $exhibition) {
                                                        if ($contact['exhibition_id'] == $exhibition['id']) {
                                                            if ($exhibition['start_date'] > $today) {
                                                                echo "upcoming";
                                                            } elseif ($exhibition['start_date'] < $today && $exhibition['end_date'] > $today) {
                                                                echo "Ongoing";
                                                            } elseif ($exhibition['end_date'] < $today) {
                                                                echo "Completed";
                                                            }
                                                        }
                                                    }
                                            ...
                                            <td>
                                                ...
                                                foreach ($exhibitions as $exhibition) {
                                                    if ($contact['exhibition_id'] == $exhibition['id']) {
                                                        if ($exhibition['start_date'] > $today) { ?>
                                                            <a onclick="return confirm('Are you sure to delete item?')?window.location.href='<?= base_url('staff/cancelorder/' . $contact['id']); ?>':false;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete exhibition">
