          ...
          <div class="d-lg-flex">
            ...
            <div class="ms-auto my-auto mt-lg-0 mt-4">
              <div class="ms-auto my-auto">
                <a href="addsliders" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Slider</a>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <?php if ($slider['status'] == 1) { ?>
                        <a href="<?= base_url('staff/deactivate/slider/' . $slider['link']); ?>"><span class="badge badge-sm bg-gradient-success">Active</span></a>
                      <?php } elseif ($slider['status'] == 0) { ?>
                        <a href="<?= base_url('staff/activate/slider/' . $slider['link']); ?>"><span class="badge badge-sm bg-gradient-secondary">Deactive</span></a>
                      <?php } ?>
                    </td>
                    <td class="align-middle">
                      <a href="<?= base_url('staff/editslider/' . $slider['link']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        <i class="fas fa-edit"></i>Edit
                      </a>&nbsp;
                      <a href="<?= base_url('staff/delete/slider/' . $slider['link']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
